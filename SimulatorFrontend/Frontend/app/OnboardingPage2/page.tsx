    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="px-4 sm:px-6 py-4 flex items-center justify-between">
        ...
        <div className="text-xs sm:text-sm text-gray-600">
          Having trouble? <span className="text-[#ef6b23] cursor-pointer hover:underline">Get Help</span>
        </div>
      </header>
        ...
        <div className="w-full max-w-3xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-x-8 md:gap-y-6">
            ...
            <div className="space-y-5 sm:space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, nationalSecurityNumber: e.target.value })
                  }
                  className="w-full px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ef6b23] focus:border-transparent text-gray-900 placeholder:text-gray-400 bg-white text-sm sm:text-base"
                />
              </div>
              ...
              <div className="flex items-start gap-2 sm:gap-3 pt-2">
                ...
                <label htmlFor="pep" className="text-xs sm:text-sm text-gray-700 leading-relaxed cursor-pointer">
                  Are you a Politically Exposed Person (PEP), or are you closely related to or associated
                  with a PEP?
                </label>
              </div>
            </div>
            ...
            <div className="space-y-5 sm:space-y-6">
              {/* Upload Passport */}
              <div>
                <label className="block text-sm font-medium text-gray-900 mb-2">Upload Passport</label>
                <label
              ...
              {/* Upload Selfie */}
              <div>
                <label className="block text-sm font-medium text-gray-900 mb-2">Upload Your Selfie</label>
                <label
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4 mt-8 sm:mt-10">
            ...
            <button className="px-4 sm:px-6 py-2.5 sm:py-3 bg-[#ef6b23] text-white rounded-lg font-semibold hover:bg-[#d85a1a] transition-colors shadow-sm text-sm sm:text-base">
              Next
            </button>
          </div>
        </div>
